  ...
  return (
    ...
    >
      ...
      <div className="grid w-full grid-cols-3 gap-[24px]">
        {/* Tier 1 - Starter */}
        <div className="flex flex-col gap-[24px] rounded-[20px] border border-[var(--border-light)] bg-[var(--white)] p-[32px]">
          <span className="text-[18px] font-semibold text-[var(--bg-dark)]">入門方案</span>
          <div className="flex items-end gap-[4px]">
            <span className="text-[36px] font-extrabold tracking-[-1px] text-[var(--bg-dark)]">
              NT$ 299
            </span>
        ...
        {/* Tier 2 - Pro (Featured) */}
        <div className="flex flex-col gap-[24px] rounded-[20px] border-2 border-[var(--primary)] bg-[var(--bg-dark)] p-[32px]">
